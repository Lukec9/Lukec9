...
Hi there! I'm a passionate 16-year-old developer specializing in the **MERN Stack** (MongoDB, Express.js, React, Node.js) and **Next.js**.I'm on a mission to build innovative web applications that solve real-world problems.
